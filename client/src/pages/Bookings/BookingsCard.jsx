...
const BookingsCard = ({ bookedInfo, handleBookingDelete }) => {
  const {
    _id,
    email,
    customer_name,
    ...
    <div className="grid lg:grid-cols-10 grid-cols-1 justify-between items-center gap-4 bg-base-200 rounded-md p-5">
      <div className="col-span-1 flex lg:flex-row gap-4 flex-col items-center">
        <button
          ...
          className="rounded-full bg-error px-2"
        >
          X
        </button>
      ...
      <div className="col-span-4">
        ...
        <p>
          <span className="font-bold">Customers massage -</span>
          {massage}
        </p>
      </div>
...
BookingsCard.propTypes = {
  ...
  handleBookingDelete: PropTypes.function,
};
